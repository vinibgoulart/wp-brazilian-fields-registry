...
/**
 * Brazilian Fields Registry validate class.
 *
 * Credits to: Woocommerce Extra Checkout Fields for Brazil
 * Removing that functions dependency from Woocommerce Extra Checkout Fields for Brazil
 *
 */
class ValidateBrazilianFields
{
	/**
